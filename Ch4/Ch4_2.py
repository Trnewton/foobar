...
if __name__ == '__main__':
    # import time 
    # verbose = True
    # test_2 = ([656, 195], [308, 32], [392, 142], 7296)
    ...
    import Ch4_2_RingSearch as ring
    ...
    for n in range(N):
        ...
        dist = np.random.randint(1, dist_max)
        ...
        start_2 = time.time()
        sol_2 = ring.solution(dim, my, tr, dist)
        end_2 = time.time()
